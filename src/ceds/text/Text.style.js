...
const computeTextStyle = (props, context) => {
  ...
  const style = [
    ...
    makeResponsive(lineHeight, 'line-height', context.lineHeight),
    makeResponsive(zIndex, 'z-index'),
    makeResponsive(overflow, 'overflow'),
    makeResponsive(opacity, 'opacity'),
    makeResponsive(letterSpacing, 'letter-spacing'),
    makeResponsive(textStyle, 'font-style'),
    makeResponsive(lineSpacing, 'line-spacing', context.lineSpacing),
    {
      ':hover': {
